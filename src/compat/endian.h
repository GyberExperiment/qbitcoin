...
// Determine endianness using compiler-specific macros
// This is more portable than std::endian for older compilers
#if defined(__BYTE_ORDER__) && defined(__ORDER_LITTLE_ENDIAN__) && defined(__ORDER_BIG_ENDIAN__)
    #define QBTC_LITTLE_ENDIAN (__BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__)
    #define QBTC_BIG_ENDIAN (__BYTE_ORDER__ == __ORDER_BIG_ENDIAN__)
    ...
    #define QBTC_LITTLE_ENDIAN 1
    #define QBTC_BIG_ENDIAN 0
    ...
    #define QBTC_LITTLE_ENDIAN 0
    #define QBTC_BIG_ENDIAN 1
#else
    // Fallback: assume little endian (most common)
    #define QBTC_LITTLE_ENDIAN 1
    #define QBTC_BIG_ENDIAN 0
#endif
